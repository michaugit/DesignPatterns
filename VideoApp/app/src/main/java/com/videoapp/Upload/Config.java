...
public class Config {
    ...
    public static final String FILE_UPLOAD_URL = "http://192.168.0.109:80/AndroidFileUpload/fileUpload.php";
    ...
    public static final String VIDEO_VISIBILITY_URL = "http://10.0.2.2:8080/dp_server_test_war_exploded/change-visibility";
